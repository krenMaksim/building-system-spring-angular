...
public final class RedactorServiceImpl extends AbstractService implements RedactorService {
	...
	if (!date) {
	    ...
	    entity.setOldRecord(oldRecord.getDate()
	                                 .toString());
	    archiveDao.storeRecordsArchive(entity);
	}
	...
	if (!ppSmeta) {
	    ...
	    Integer idSmeta = smetaDao.loadSmetaByPp(oldRecord.getPpSmeta())
	                              .getPp();
	    if (idSmeta != null) {
	...
	if (!kolVo) {
	    ...
	    entity.setOldRecord(oldRecord.getKolVo()
	                                 .toString());
	    archiveDao.storeRecordsArchive(entity);
	}
	...
	if (!userId) {
	    ...
	    entity.setOldRecord(oldRecord.getUserId()
	                                 .toString());
	    archiveDao.storeRecordsArchive(entity);
	}
    }
